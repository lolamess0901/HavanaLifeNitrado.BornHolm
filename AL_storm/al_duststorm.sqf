...
[[[],"AL_storm\alias_duststorm_effect.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;

if (_dust_wall) then {
	// perete de praf
	_rand_pl = [] execVM "AL_storm\alias_hunt.sqf";
	...
	[[[_stormsource,_duration_duststorm],"AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
	sleep 0.1;
	[[[_stormsource_1,_duration_duststorm],"AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
	sleep 0.1;
	[[[_stormsource_2,_duration_duststorm],"AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
	sleep 0.1;
	[[[_stormsource_3,_duration_duststorm],"AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
	sleep 0.1;
	[[[_stormsource_4,_duration_duststorm],"AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
	sleep 0.1;
	[[[_stormsource_5,_duration_duststorm],"AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
	sleep 0.1;
	[[[_stormsource_6,_duration_duststorm],"AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
};
